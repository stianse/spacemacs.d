...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-editing-style '(vim :variables
                                    ;; Move text with J and K in visual mode
...
before packages are loaded."
  ...
  (load-file (concat dotspacemacs-directory "user-config-kb-meeting-capture.el"))
  ...
  ;; Backups
  ;; See https://github.com/syl20bnr/spacemacs/issues/8947
  ...
  (setq backup-directory-alist '(("" . "/home/stianse/.emacs.d/.cache/backups/per-save")))

  (defun force-backup-of-buffer ()
    (message "force backup")
    ;; Make a special "per session" backup at the first save of each
    ;; emacs session.
    (when (not buffer-backed-up)
      (message "no buffer-backed-up")
      ;; Override the default parameters for per-session backups.
      (let ((backup-directory-alist '(("" . "/home/stianse/.emacs.d/.cache/backups/per-session")))
            (kept-new-versions 3))
        (backup-buffer)))
